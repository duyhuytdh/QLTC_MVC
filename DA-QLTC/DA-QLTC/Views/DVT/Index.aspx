<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<IEnumerable<DA_QLTC.Models.DM_DVT>>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="text-align: center; margin: 0px auto; padding-left: 200px">
        <h2 class="h2">Danh mục đơn vị tính</h2>
    </div>

 <p>
        <label class="glyphicon glyphicon-plus"></label>
        <%: Html.ActionLink("Thêm đơn vị tính", "Create") %>
    </p>
...
<% foreach (var item in Model) { %>
    <tr>
        ...
        <td>
            <%: Html.DisplayFor(modelItem => item.KI_HIEU) %>
        </td>
         <td>
            1 USD =
            <%:Html.DisplayFor(modelItem => item.QUY_DOI_USD) %>   
            <%=item.KI_HIEU%>
        </td>
        <td>
